...
int main(){
	...
	printf("Digite o peso de %s (Ex. 80): ", &nome1); //porque tenho que colocar & antes das variáveis em alguns casos e outros não (tenho que colocar no string e não nos números)
	scanf("%f", &peso1);
