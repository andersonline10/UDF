...
pessoas e ao final apresentar a média de idade de ambos os gêneros catalogados. (do...while) */ 

#include <stdio.h>

int  main(){
	int contador = 1, sexo, idade, pessoas, soma_idade_masc = 0, soma_idade_fem = 0, soma_sexo_masc = 0, soma_sexo_fem = 0, rodada = 1;
